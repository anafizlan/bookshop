...
<div class="container">
    ...
    <div class="card">
        ...
        <form method="POST"
            ...
            <input type="text"
                   name="name"
                   value="{{ old('name', $user->name) }}" style="width:94%;">

            <label>Email</label>

            <input type="email"
                   name="email"
                   value="{{ old('email', $user->email) }}" style="width:94%;">

            <label>Profile Picture</label>

            <input type="file"
                   name="pfp" style="width:94%;" accept="image/*">
    ...
    <div class="card">
        ...
        <form method="POST"
              action="{{ route('password.update') }}" style="width:94%;">
